...
@section('title', 'Dashboard - ' . ($globalSettings['app_name'] ?? 'SIM Kendaraan'))
                ...
                <table class="w-full text-left border-collapse">
                    ...
                    <tbody class="divide-y divide-slate-100 dark:divide-slate-800">
                        <tr class="hover:bg-slate-50 dark:hover:bg-slate-800/30 transition-colors">
                            ...
                            <td class="px-6 py-4 text-sm font-semibold text-slate-900 dark:text-slate-300">Bagian Umum</td>
                        ...
                        <tr class="hover:bg-slate-50 dark:hover:bg-slate-800/30 transition-colors">
                            ...
                            <td class="px-6 py-4 text-sm font-semibold text-slate-900 dark:text-slate-300">Bagian Keuangan
                            </td>
                            <td class="px-6 py-4 text-sm text-right tabular-nums text-slate-600 dark:text-slate-300">
                                3.000.000.000</td>
                            <td class="px-6 py-4 text-sm text-right tabular-nums text-slate-600 dark:text-slate-300">
                        ...
                        <tr class="hover:bg-slate-50 dark:hover:bg-slate-800/30 transition-colors">
                            ...
                            <td class="px-6 py-4 text-sm font-semibold text-slate-900 dark:text-slate-300">Bagian SDM</td>
                            <td class="px-6 py-4 text-sm text-right tabular-nums text-slate-600 dark:text-slate-300">
                                2.500.000.000</td>
                            <td class="px-6 py-4 text-sm text-right tabular-nums text-slate-600 dark:text-slate-300">
                                1.000.000.000</td>
